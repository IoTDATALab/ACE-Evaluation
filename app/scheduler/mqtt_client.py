...
PUB_TARGETS = {'mnv2_1':brokerid,'mnv2_2':brokerid,'mnv2_3':brokerid,'detector_1':brokerid,'detector_2':brokerid,'detector_3':brokerid}
...
class MqttClient:
    ...
    def _on_client_message(self, mqtt_client, userdata, msg):
        ...
        if rev_msg['type'] == "cmd":
            ...
            # logger.debug("the received msg is img")
